...
type MobileProductCarouselCardProps = {
	product: TProduct | null;
};

export default function MobileProductCarouselCard({
	product,
}: MobileProductCarouselCardProps) {
	...
	return (
		...
		>
			<Link
				...
				onClick={async () =>
					updateProductViews(product?._id as string)
				}
			>
				<Box
					sx={{
